...
var EN = {
  ...
  loop: {
    ...
    preflightStillOver: "preflight: still ~{estimate}/{ctxMax} tokens ({pct}%) after aggressive re-fold \u2014 request may fail. Run /clear or /new to start fresh.",
...
var zhCN = {
  ...
  loop: {
    ...
    preflightStillOver: "\u9884\u68C0\uFF1A\u6FC0\u8FDB\u6298\u53E0\u540E\u4ECD\u6709\u7EA6 {estimate}/{ctxMax} tokens\uFF08{pct}%\uFF09\u2014 \u8BF7\u6C42\u53EF\u80FD\u5931\u8D25\u3002\u8BF7\u8FD0\u884C /clear \u6216 /new \u91CD\u65B0\u5F00\u59CB\u3002",
