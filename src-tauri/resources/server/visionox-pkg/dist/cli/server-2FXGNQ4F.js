...
import { basename, dirname as dirname3, join as join4, resolve as resolvePath } from "path";
...
async function handleMemory(method, rest, body, ctx) {
  ...
  if (method === "GET" && rest.length === 0) {
    ...
    const projectMemoryPath = existingProjectMemory ?? (cwd ? join4(cwd, PROJECT_MEMORY_FILE) : null);
...
//# sourceMappingURL=server-2FXGNQ4F.js.map