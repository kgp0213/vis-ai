...
function SelectRow({
  ...
  return /* @__PURE__ */ React2.createElement(Box, { flexDirection: "column" }, /* @__PURE__ */ React2.createElement(Box, null, /* @__PURE__ */ React2.createElement(Text, { color: rowColor, bold: active, dimColor: item.disabled }, marker, " ", item.label)), item.hint ? /* @__PURE__ */ React2.createElement(Box, { paddingLeft: marker.length + 1 }, /* @__PURE__ */ React2.createElement(Text, { dimColor: true }, item.hint)) : null);
}
...
//# sourceMappingURL=chunk-NLV2YORE.js.map