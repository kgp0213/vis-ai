...
description: Use when joining an unfamiliar repository to map its architecture, entry points, conventions, and project instructions.
origin: ECC
---

# Codebase Onboarding

Systematically analyze an unfamiliar codebase and produce a structured onboarding guide for developers or AI-assisted development.

## When to Use

- First time opening a project in Visionox
- Joining a new team or repository
- User asks "help me understand this codebase"
- User asks to generate or update project instructions (`AGENTS.md` or `CLAUDE.md`)
...
#### Output 2: Starter Project Instructions

Generate or update project-specific instructions based on detected conventions. Prefer an existing `AGENTS.md` or `CLAUDE.md`; read it first, preserve existing instructions, and clearly call out what changed. If neither exists, use `AGENTS.md` unless the user requests another supported filename.
...
3. **Respect existing project instructions** — enhance `AGENTS.md` or `CLAUDE.md` rather than replacing it. Call out what's new vs existing.
...
- Generating project instructions longer than 100 lines — keep them focused
...
**Action**: Run full 4-phase workflow → produce Onboarding Guide + starter project instructions
**Output**: Onboarding Guide printed directly to the conversation, plus project instructions written to the project root

### Example 2: Generate AGENTS.md for existing project
**User**: "Generate project instructions for this project"
...
### Example 3: Enhance existing project instructions
**User**: "Update AGENTS.md with current project conventions"
**Action**: Read existing project instructions, run Phases 1-3, merge new findings
**Output**: Updated project instructions with additions clearly marked
