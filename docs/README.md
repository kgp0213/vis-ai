...
| [模型配置 JSON 参数说明](模型配置JSON参数说明.md) | 面向维护人员和辅助编辑配置的 AI，说明新增、更新、停用模型所需字段、范围与模板 |
...
发布前的版本配置、已知问题状态、安全审计与行动清单属于一次性评审，按维护规则不作为长期独立文档保留；
评审完成后归档到 `archive/`，下次发布前重新评审并覆盖。当前 `archive/` 下存放历史评审与一次性任务拆分快照：

- `archive/发布前审查_v1.28.0.md` — v1.28.0 发布前评审（2026-07-14 时点）
- `archive/TEAM_TASK_ALLOCATION.md` — 团队任务拆分快照（2026-07-14 v1.0，数量与行数已过时）
