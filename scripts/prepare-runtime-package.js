...
for (const file of ["package.json", "package-lock.json", "dashboard/index.html", "dashboard/app.css", "dashboard/katex-support.js", "dashboard/backup-support.js"]) copyFile(file);
