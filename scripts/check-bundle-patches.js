...
const required = [
  ...
  },
  {
    ...
    markers: ["createScheduleRunRegistry", "decideScheduleAdmission", "decideRejectedScheduleSubmission", "repairInterruptedSchedule", "markScheduleCancellationRequested", "requiresBoundWorkspace"],
  },
  {
  ...
  },
  {
    ...
    markers: ["routeAutomaticSkill", "TECHNICAL_DISCUSSION", 'name: "weather"'],
  },
  {
    file: "src-tauri/src/lib.rs",
    markers: ["pick_directory", "FolderBrowserDialog", "validated_directory_result", ".env(\"PATH\", runtime_path)"],
  },
  {
    file: "src/index.html",
    markers: ["vis_pick_directory", "vis_pick_directory_result", 'invoke("pick_directory")'],
  },
  {
