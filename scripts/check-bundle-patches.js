...
const required = [
  ...
  },
  {
    ...
    markers: ["getSessionTranscript", "rest[1] === \"transcript\"", "rest[1] === \"fork\"", "forkSession", "projectExecutionTranscript", "paginateExecutionTranscript", "const hostCommands = ctx.getSlashCommands?.()", "VISIONOX_PATCH_RUNTIME_MIRROR_SETTINGS", "VISIONOX_PATCH_SESSION_SNAPSHOT_V1", "snapshotMessages", "snapshotPage", "normalizeRuntimeMirrorSettings", "parsedDelivery", "parsedAdmittedInputId"],
  },
  {
    file: "src-tauri/resources/server/visionox-pkg/dist/cli/chunk-2R4QCDOZ.js",
    markers: ["parallelBatchPlanner", "Parallel tool planning failed; continuing serially", "getResultAugmenter", "this._interceptor(name, args, opts)", "this._resultAugmenter(name, args, finalResult, opts)"],
  },
  {
    file: "src-tauri/resources/server/visionox-pkg/dist/cli/chunk-O52OLQL3.js",
    markers: ["operationId: getOperationId(ctx?.signal)", "ownerId: getOperationId(ctx?.signal)", "const normalizeCommand = typeof opts.normalizeCommand"],
  },
  {
  ...
  },
  {
    ...
    markers: [
      ...
      "createProgressiveToolDiscovery",
      "createOperationSteeringRuntime",
      "createSessionInputAdmission",
      "sessionInputAdmission.promoteSteers",
      "scheduleQueuedSessionInputDrain",
      "projectToolProgressEvent",
  ...
  },
  {
    ...
    markers: [
      ...
      "copyVHomeValue(vhomeLoginUrl, t4(\"appPanel.authLink\"))",
  ...
  },
  {
    ...
    markers: [
      ...
      "const projected = await env.onResult",
      ...
      "a read_media tool can queue an image during this same",
      "_pendingMediaParts",
  ...
  },
  {
    ...
    markers: [
      ...
      "Always force-terminate the complete tree",
      "killer.once(\"close\", (code) => done(code === 0))",
      "job.stopPromise",
      "termination-pending",
      "terminationPending: job.terminationPending === true",
      "A runtime ChildProcess error does not prove",
