...
const required = [
  ...
  },
  {
    ...
    markers: ["getSessionTranscript", "rest[1] === \"transcript\"", "rest[1] === \"fork\"", "forkSession", "projectExecutionTranscript", "paginateExecutionTranscript", "const hostCommands = ctx.getSlashCommands?.()", "VISIONOX_PATCH_RUNTIME_MIRROR_SETTINGS", "normalizeRuntimeMirrorSettings", "parsedDelivery", "parsedAdmittedInputId"],
  },
  {
