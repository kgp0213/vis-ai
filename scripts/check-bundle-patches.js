...
const required = [
  ...
  },
  {
    ...
    markers: ["createDocumentMarkdownManager", "renderCollectionSources", "messagesWithBatchVisuals", "generateHierarchicalSummary", "recoverSavedBatch", "orphan-section", "onPersistenceError", "policy-selected", "completed_with_warnings", "classifyDocumentModelError", "modelDiagnostics", "buildDocumentQualityWarnings", "waiting_foreground", "waiting_provider", "isProviderBusy", "retryFailed", 'action === "abandon"', 'action === "delete"', "completions.delete"],
  },
  {
